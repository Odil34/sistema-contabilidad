namespace sistema_contabilidad.Formularios
{
    partial class FrmBalanceGeneral
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTitulo.Text = "Balance General";
            ...
            panelResultado.Controls.Add(lblCuadre);
            ...
            lblCuadre.Dock = DockStyle.Fill;
            lblCuadre.Font = new Font("Segoe UI", 11F, FontStyle.Bold);
            lblCuadre.Location = new Point(0, 0);
            lblCuadre.Name = "lblCuadre";
            lblCuadre.Padding = new Padding(16, 0, 16, 0);
            lblCuadre.Size = new Size(760, 55);
            lblCuadre.TabIndex = 0;
            lblCuadre.Text = "Ecuación contable";
            lblCuadre.TextAlign = ContentAlignment.MiddleLeft;
            ...
            Name = "FrmBalanceGeneral";
            Text = "Balance General";
            Load += FrmBalanceGeneral_Load;
