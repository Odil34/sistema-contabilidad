namespace sistema_contabilidad.Formularios
{
    partial class FrmCalculadoraIva
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTotal = new Label();
            btnUsarBase = new Button();
            btnUsarIva = new Button();
            btnUsarTotal = new Button();
            ...
            btnUsarBase.Enabled = false;
            btnUsarBase.FlatStyle = FlatStyle.Flat;
            btnUsarBase.Location = new Point(20, 340);
            btnUsarBase.Name = "btnUsarBase";
            btnUsarBase.Size = new Size(118, 34);
            btnUsarBase.TabIndex = 4;
            btnUsarBase.Text = "Usar Base";
            btnUsarBase.UseVisualStyleBackColor = true;
            btnUsarBase.Click += btnUsarBase_Click;
            btnUsarIva.BackColor = Color.FromArgb(39, 128, 73);
            btnUsarIva.Enabled = false;
            btnUsarIva.FlatStyle = FlatStyle.Flat;
            btnUsarIva.ForeColor = Color.White;
            btnUsarIva.Location = new Point(146, 340);
            btnUsarIva.Name = "btnUsarIva";
            btnUsarIva.Size = new Size(118, 34);
            btnUsarIva.TabIndex = 5;
            btnUsarIva.Text = "Usar IVA";
            btnUsarIva.UseVisualStyleBackColor = false;
            btnUsarIva.Click += btnUsarIva_Click;
            btnUsarTotal.Enabled = false;
            btnUsarTotal.FlatStyle = FlatStyle.Flat;
            btnUsarTotal.Location = new Point(272, 340);
            btnUsarTotal.Name = "btnUsarTotal";
            btnUsarTotal.Size = new Size(118, 34);
            btnUsarTotal.TabIndex = 6;
            btnUsarTotal.Text = "Usar Total";
            btnUsarTotal.UseVisualStyleBackColor = true;
            btnUsarTotal.Click += btnUsarTotal_Click;
            AcceptButton = btnCalcular;
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(420, 395);
            Controls.Add(btnUsarBase);
            Controls.Add(btnUsarIva);
            Controls.Add(btnUsarTotal);
        ...
        private Button btnUsarIva;
        private Button btnUsarTotal;
    }
}
