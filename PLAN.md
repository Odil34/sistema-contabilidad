...
- [x] **Día 3 (mié 23/09):** Libro Diario (partida doble), Mayorización (Libro Mayor), Balance de Comprobación, Estados financieros (Balance General y Estado de Resultados), Liquidación de IVA, Login + roles/usuarios, módulo de Salud Financiera y ejecutable.
